...
class Vuelo(models.Model):
    ...
    costo = models.DecimalField(max_digits=30, blank=False, null=False )

class Escala(models.Model):
    vuelo = models.ForeignKey(Vuelo,on_delete=models.CASCADE)
    nombre_procedencia = models.CharField(max_length=30,null=False,blank=False)
    cod_procedencia = models.IntegerField(max_length=30,null=False,blank=False)
    nombre_destino = models.CharField(max_length=30,null=False,blank=False)
    cod_destino = models.IntegerField(max_length=30,null=False,blank=False)
